...
export function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 w-full border-b border-border transition-all duration-300 ${
      ...
      <div className="container mx-auto flex h-14 md:h-16 items-center justify-between px-4 animate-slide-up">
        <div className="flex items-center space-x-2">
          <span className="text-lg md:text-xl font-bold bg-gradient-hero bg-clip-text text-transparent hover:scale-105 transition-transform cursor-pointer">
            DevTools
          </span>
        </div>
